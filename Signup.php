  ...
  if ($_POST['user_pass'] == $_POST['user_passCnfrm']) {
   ...
   if (mysqli_num_rows(user_info($user_email)) > 0) {
     $msg = "Email Already In Use ";
      ...
      if ($userREG->register($user_name,$user_email,$user_pass,$user_name,$user_phone,$user_dob)) {
    ...
    $msg = "<strong>Warning!</strong> Password did'nt  Match";
  }
              ...
              <div class="col-md-12 col-lg-12 col-xl-12">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="user_dob" placeholder="Enter DOB" name="user_dob">
                    </div>
                  </div>
